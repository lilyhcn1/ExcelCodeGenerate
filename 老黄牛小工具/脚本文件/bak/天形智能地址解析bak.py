...
keywords=fv
print(keywords)
url="http://api.tianapi.com/txapi/addressparse/index?key=6fc9b18a18857af8ae0619e0ec3de9ee&text=" +urllib.parse.quote(keywords)
...
print(page)
arrtemp=json.loads(page)
print(arrtemp['code'])
print(arrtemp['newslist'][0])
arr=arrtemp['newslist'][0]
#-----------------------最终写入数据---------------------
savearr2json(arr)
