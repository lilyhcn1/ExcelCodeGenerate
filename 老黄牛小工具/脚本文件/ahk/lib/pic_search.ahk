if(A_IsCompiled)
{
  global my_dll_path := A_ScriptDir . "/lib/cpp2ahk.dll"
}
else
{
  SplitPath,A_LineFile,,dir
  global my_dll_path := dir . "/cpp2ahk.dll"
}

global my_lib_MulDivProc :=  DllCall("GetProcAddress", "Ptr", DllCall("LoadLibrary", "Str", my_dll_path, "Ptr"), "AStr", "cpp2ahk", "Ptr")
...
spdlog(str := "", mode := "info")
{
    ...
    result := DllCall(my_lib_MulDivProc, "str", buf, "str", out_str, "Cdecl Int")
    if(result != 0)
    {
